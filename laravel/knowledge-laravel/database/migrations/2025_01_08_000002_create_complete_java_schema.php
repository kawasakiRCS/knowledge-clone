...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('knowledges', function (Blueprint $table) {
            $table->bigInteger('knowledge_id')->primary();
        ...
        Schema::create('comments', function (Blueprint $table) {
            $table->bigInteger('comment_no')->primary();
        ...
        Schema::create('knowledge_files', function (Blueprint $table) {
            $table->bigInteger('file_no')->primary();
            $table->integer('knowledge_id')->nullable();
        ...
        Schema::create('activities', function (Blueprint $table) {
            $table->bigInteger('activity_no')->primary();
            $table->integer('user_id')->nullable();
        ...
        Schema::create('notify_configs', function (Blueprint $table) {
            $table->integer('user_id')->nullable();
            $table->integer('notify_mail')->nullable();
            $table->integer('notify_desktop')->nullable();
            ...
            $table->integer('to_item_ignore_public')->nullable();
        ...
        Schema::create('template_items', function (Blueprint $table) {
            $table->integer('type_id')->nullable();
            $table->bigInteger('item_no')->primary();
        ...
        Schema::create('webhook_configs', function (Blueprint $table) {
            ...
            $table->timestamp('update_datetime')->useCurrent();
            $table->integer('delete_flag')->nullable();
            $table->integer('ignore_proxy')->nullable();
        ...
        Schema::create('webhooks', function (Blueprint $table) {
            $table->bigInteger('webhook_id')->primary();
            $table->integer('status')->nullable();
            $table->string('hook')->nullable();
            $table->text('content')->nullable();
            $table->integer('insert_user');
